...
A Pacscal, FORTH and Lisp version are included. The FORTH and Lisp version will be used for hardware setup and validation and the Pascal version will be used in production as the final firmware for my specific variation.

All versions will have feature parity so if you want to use an ATMega or an ESP32 you are covered. This project is meant to be as open and flexible as posssible while still maintaining a clear vision and a consistent outcome. 
